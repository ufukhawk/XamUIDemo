...
namespace XamUIDemo.Droid.Renderers
{
    public class RoundedCornerOutlineProvider : ViewOutlineProvider
    {
        ...
        public override void GetOutline(global::Android.Views.View view, Outline outline)
        {
            if (_pancake.Sides != 4)
            {
                var hexPath = XamUIDemo.Droid.Renderers.ShapeUtils.CreatePolygonPath(view.Width, view.Height, _pancake.Sides, _pancake.HasShadow ? 0 : _pancake.CornerRadius.TopLeft, _pancake.OffsetAngle);
